...
const DEFAULT_SETTINGS_BASE = {
  ...
  complianceEnabled: false, // Enable compliance checks by default
  complianceModules: ['cafe', 'hipaa', 'osha', 'gdpr', 'attorneyClientPrivilege', 'usSanctions'], // Enabled compliance modules
  compliance: { // Module-specific settings
    cafe: { energyThreshold: 0.1, emissionsLimit: 50 },
    hipaa: { encryptionRequired: true, auditLogging: true },
    osha: { ergonomicsCheck: true, mentalHealthMonitoring: true },
    gdpr: { consentRequired: true, rightToErasure: true },
    attorneyClientPrivilege: { privilegeDetection: true, communicationLogging: true },
    usSanctions: { geographicRestrictions: true, transactionMonitoring: true, exportControls: true }
  },
};
